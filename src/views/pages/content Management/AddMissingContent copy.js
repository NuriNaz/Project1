        ...
        >
          {({
            ...
            >
              ...
              {/* <FormControl
                fullWidth
                error={Boolean(touched.author_bio && errors.author_bio)}
                sx={{ ...theme.typography.customInput }}
              >
                <InputLabel htmlFor="outlined-adornment-author_bio">
                  Author Bio{" "}
                </InputLabel>
                <OutlinedInput
                  style={{
                    border:
                      values.author_bio === "" ? "1px solid red" : "unset",
                  }}
                  id="outlined-adornment-author_bio"
                  type="text"
