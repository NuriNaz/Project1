...
const ViewTemplate2 = () => {
  ...
  return (
    <MainCard title="2-ICYMI Cartoon"
      // title={
    ...
    >
      ...
      <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 1 }}>
        ...
        <Grid item xs={4}>
          <Item className="upper" style={{ textAlign: "center", display:'none' }}>
            2 COL. POLL
          </Item>
          <p style={{ textAlign: "center" }}>In Case You Missed It</p>
          <div className="ICYMI icymi_Cartoon">
            <Item className="qr " style={{ width: "50%" }}>
              <div className="scanner scan5 right_col ami this">QR4- POLL</div>
              <p className="sixty">60x60</p>
              ...
              <p>
                ...
                <br /> 
                ICYMI
                {/* {data?.templateColumns?.c5?.category_type} */}
              </p>
              <p>
                <span className="bold boldc5">Content Type:</span>
                <br /> 
                AI
                {/* {data?.templateColumns?.c5?.content_type} */}
              </p>
            </Item>
            <Item className="qr" xs={1.5} style={{ width: "50%" }}>
            <div className="scanner scan5 right_col ami this">QR4- POLL</div>
              <p className="sixty">60x60</p>
              ...
              <p>
                <span className="bold boldc5">Content Category:</span>
                <br /> 
                {/* {data?.templateColumns?.c6?.category_type} */}
                ICYMI
              </p>
              <p>
                <span className="bold boldc5">Content Type:</span>
                <br /> 
                AI
                {/* {data?.templateColumns?.c6?.content_type} */}
              </p>
        ...
        {/* <Grid className="left_column" item xs={2}>
          ...
          <Item className="item6 columnnC5">
            ...
            <div className="COLUMN_1Xx poll">
              <p>ICYMI COL 1</p>
              <p> 267x1062</p>
            </div>
          </Item>
          <Item className="item7 columnC6">
            <p className="bold">C6</p>
            <p>
              <span className="bold boldc5">Content Category:</span>
              <br /> {data?.templateColumns?.c6?.category_type}
